...
//     resumo: 'Experiência sólida em organização de processos, gestão de documentos e suporte operacional.',
//     skills: [
...
//     skills: [
//       'Suporte Help Desk (nível 1 a campo)',
...
//     skills: [
//       'Desenvolvimento com Next.js, TypeScript e Tailwind CSS',
...
//               <h2 className="card-title text-xl text-accent">{habilidade.titulo}</h2>
