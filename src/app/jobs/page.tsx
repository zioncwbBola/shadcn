...
//     descricao: 'Consultoria especializada na implementação e otimização de sistemas empresariais e soluções para pontos de venda, com foco em eficiência e personalização.',
//   },
//   {
//     ano: '2022 - 2023',
//     titulo: 'Desenvolvedor Web Full Stack',
//     descricao: 'Criação de aplicações web com Next.js, TypeScript e Tailwind CSS. Foco em design responsivo, integração de APIs e otimização de performance.',
//   },
//   {
//     ano: '2020 - 2022',
//     titulo: 'Especialista em Marketing Digital',
//     descricao: 'Implantação e gestão de estratégias digitais, incluindo SEO, campanhas pagas e automação de marketing para diversas marcas.',
//   },
//   {
//     ano: '2017 - 2020',
//     titulo: 'Suporte Técnico (Help Desk e Campo)',
//     descricao: 'Atuação no suporte técnico de nível 1 até suporte de campo, solucionando problemas de hardware, software e infraestrutura de TI.',
//   },
//   {
//     ano: '2015 - 2017',
//     titulo: 'Designer Gráfico e Arte Finalista',
//     descricao: 'Criação de materiais gráficos para impressão e digital, incluindo arte final e processos de impressão.',
//   },
//   {
//     ano: '2013 - 2015',
//     titulo: 'Assistente Administrativo',
//     descricao: 'Organização de processos administrativos, gestão de documentos e suporte operacional para equipes e setores diversos.',
//   },
// ];
      ...
      <div className="grid gap-6">
        <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          <div className="card-body">
            <h2 className="card-title text-xl text-accent">Experiência Profissional</h2>
            <p className="text-sm text-neutral-content">Aqui estão alguns dos meus principais cargos e responsabilidades.</p>
        ...
        <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          <div className="card-body">
            ...
            <p className="text-sm text-neutral-content">Aqui está minha formação acadêmica.</p>
            <ul className="list-disc list-inside mt-4 text-sm">
              <li>Bacharelado em Ciência da Computação, Universidade X (2015 - 2019)</li>
